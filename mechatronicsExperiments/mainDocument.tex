...
\usepackage{tikz}
% load libraries
\usetikzlibrary{backgrounds,calc,patterns,decorations.pathmorphing,decorations.markings,snakes}
\usepackage[siunitx,smartlabels,american]{circuitikzgit}
\def\smgrid{0.5}
...
% 2. Activate the following two lines
 ...
 %%%%%
 % \input{latex/labBookMechatronics/BBBlueIntroC.tex}
 % \input{latex/labBookMechatronics/TLC.tex}

 \input{latex/labBookMechatronics/ADC-BBBlue.tex}
